...
{if $matchers[$guid]}
	...
	*}
		<a target="_blank" href="http://www.facebook.com/dialog/feed?app_id=189260257772056&to={$guid}&redirect_uri=http%3A%2F%2Flikebright.com%2Fcupid%2Fclose.html&link=http://likebright.com/cupid/&description= &name=I just voted on someone you should date.&caption=Play matchmaker and learn who your friends think is right for you.">
